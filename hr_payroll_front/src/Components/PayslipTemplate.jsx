...
const PayslipTemplate = forwardRef(
  ({ payroll, isEditable = false, onSave, isPdfView = false }, ref) => {
    ...
    const handleExportPdf = async () => {
      ...
      try {
        ...
        saveAs(
          blob,
          `payslip_${editedData.employee?.id || 'emp'}_${
            editedData.month || 'current'
          }.pdf`
        );
    ...
    const displayTotalDeductions = isEditing
    ...
    const taxMode = summary.mode;
    const nonTaxableAllowancesTotal = Number(summary.nonTaxableAllowances || 0);
    const exemptionsApplied = Array.isArray(summary.exemptionsApplied)
      ? summary.exemptionsApplied
      : [];
    const contributionData = contributions || {};
    const employeePensionAmount = Number(contributionData.employeePension || 0);
    const employerPensionAmount = Number(contributionData.employerPension || 0);
    const employeePensionPercent = Number(
      contributionData.employeePensionPercent || 0
    );
    const employerPensionPercent = Number(
      contributionData.employerPensionPercent || 0
    );
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: '0.875rem', color: 'rgb(100,116,139)' }}>
              Payslip for
            </div>
            <div style={{ fontSize: '1.125rem', fontWeight: 600 }}>{month}</div>
            <div style={{ fontSize: '0.75rem', marginTop: '0.5rem' }}>
              Payslip ID: {`${employee?.id}-${month}`}
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <table style={{ fontSize: '0.875rem' }}>
              <tbody>
                ...
                <tr>
                  <td style={{ paddingRight: '0.5rem' }}>Employee ID:</td>
                  <td>{employee?.id}</td>
                </tr>
                <tr>
            ...
            <table style={{ width: '100%', fontSize: '0.875rem' }}>
              <tbody>
                    ...
                    <td style={{ width: '75%' }}>
                      {isEditing ? (
                        <input
                          ...
                          value={e.label || ''}
                          onChange={(ev) =>
                            handleEarningsChange(idx, 'label', ev.target.value)
                          }
                          style={{
                            border: '1px solid #ccc',
                            borderRadius: '0.25rem',
                ...
                <tr style={{ borderTop: '1px solid #ccc', fontWeight: 600 }}>
                  ...
                  <td style={{ textAlign: 'right' }}>
                    {(Number(displayGross) || 0).toLocaleString()}
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <table style={{ width: '100%', fontSize: '0.875rem' }}>
              <tbody>
                ...
                <tr style={{ borderTop: '1px solid #ccc', fontWeight: 600 }}>
                  ...
                  <td style={{ textAlign: 'right' }}>
                    {(Number(displayTotalDeductions) || 0).toLocaleString()}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          >
            ...
            <table style={{ width: '100%', fontSize: '0.875rem' }}>
              <tbody>
                {taxMode && (
                  <tr>
                    <td style={{ width: '75%' }}>Tax Mode</td>
                    <td style={{ textAlign: 'right', fontWeight: 600 }}>
                      {taxMode}
                    </td>
                  </tr>
                )}
                {(nonTaxableAllowancesTotal > 0 || taxMode) && (
                  <tr>
                    <td style={{ width: '75%' }}>Non-taxable Allowances</td>
                    <td style={{ textAlign: 'right', fontWeight: 600 }}>
                      {nonTaxableAllowancesTotal.toLocaleString()}
                    </td>
                  </tr>
                )}
              </tbody>
            ...
            {exemptionsApplied.length > 0 && (
              <div style={{ marginTop: '0.75rem' }}>
                ...
                <table style={{ width: '100%', fontSize: '0.875rem' }}>
                  <tbody>
                    {exemptionsApplied.map((ex, idx) => (
                      <tr key={`${ex.name || 'exemption'}-${idx}`}>
                        <td style={{ width: '75%' }}>
                          {ex.name || 'Exemption'}
                        </td>
                        <td style={{ textAlign: 'right' }}>
                          <span style={{ fontWeight: 600 }}>
                            {(Number(ex.applied) || 0).toLocaleString()}
                          </span>
                          {typeof ex.limit !== 'undefined' && (
                            <span
                              style={{
                            ...
                            >
                              / {(Number(ex.limit) || 0).toLocaleString()} cap
                            </span>
                          )}
                        </td>
                      </tr>
                ...
                <table style={{ width: '100%', fontSize: '0.875rem' }}>
                  <tbody>
                    {(employeePensionAmount > 0 ||
                      employeePensionPercent > 0) && (
                      <tr>
                        <td style={{ width: '75%' }}>Pension (Employee)</td>
                        <td style={{ textAlign: 'right' }}>
                          <span style={{ fontWeight: 600 }}>
                            {employeePensionAmount.toLocaleString()}
                          </span>
                          {employeePensionPercent > 0 && (
                            <span
                              style={{
                            ...
                            >
                              ({employeePensionPercent}% of gross)
                            </span>
                          )}
                        </td>
                      </tr>
                    ...
                    {(employerPensionAmount > 0 ||
                      employerPensionPercent > 0) && (
                      <tr>
                        <td style={{ width: '75%' }}>Pension (Employer)</td>
                        <td style={{ textAlign: 'right' }}>
                          <span style={{ fontWeight: 600 }}>
                            {employerPensionAmount.toLocaleString()}
                          </span>
                          {employerPensionPercent > 0 && (
                            <span
                              style={{
                            ...
                            >
                              ({employerPensionPercent}% of gross)
                            </span>
                          )}
                        </td>
                      </tr>
