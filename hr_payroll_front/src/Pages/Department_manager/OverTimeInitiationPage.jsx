...
const OvertimeInitiationPage = () => {
  ...
  const handleConfirm = async () => {
    ...
    setSubmitting(true);
    try {
      await axiosPrivate.post('/attendances/requests/overtime/', {
        date,
        hours: Number(hours),
        justification,
  ...
  return (
    <div className="bg-gray-50 dark:bg-slate-700 min-h-screen px-4 py-8 font-sans relative transition-colors duration-200">
      ...
      {toast.show && (
        <div
          className={`fixed top-6 right-6 z-[9999] px-6 py-3 rounded-xl shadow-2xl transition-all border
          ${
            toast.type === 'success'
      ...
      <div className="mx-auto">
        <div className="mb-6">
          <Header
            ...
            subTitle={
              'Assign overtime hours to team members for specific dates.'
            }
          />
        </div>
