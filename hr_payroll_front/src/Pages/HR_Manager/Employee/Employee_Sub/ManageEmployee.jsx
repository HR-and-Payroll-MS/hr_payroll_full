...
export default function ManageEmployee() {
  ...
  const table_header = (
    <thead className={`bg-slate-100 dark:bg-slate-700  rounded-xl`}>
      <tr className="justify-evenly  ">
        <th className=" px-4 py-3">
          <div className="flex w-full justify-between items-center ">
            <div className="flex gap-1.5">
              ...
              />
              <p
                className={`font-semibold text-gray-500  text-xs  dark:text-slate-200`}
              >
                Employee Name
              </p>
            </div>
        ...
        <th className=" px-4 py-3">
          <div className="flex w-full justify-between items-center ">
            <p
              className={`font-semibold text-gray-500  text-xs  dark:text-slate-300`}
            >
              Job Title
            </p>
            <img
        ...
        <th className=" px-4 py-3">
          <div className="flex w-full justify-between items-center ">
            <p
              className={`font-semibold text-gray-500  text- dark:text-slate-300`}
            >
              Office
            </p>
            <img
  ...
  const table_content = (
    <tbody>
      {items.map((fruit, idx) => (
        <tr
          key={fruit}
          className={`hover:bg-slate-50   dark:bg-slate-800  font-semibold text-sm dark:text-slate-400 text-gray-700  dark:hover:bg-slate-700`}
        >
          <td className="border-b border-gray-100 dark:border-gray-600 dark:text-slate-400 px-4 py-2">
            <div className="flex  w-full justify-start items-center gap-2 ">
              ...
              <img
                ...
                src="\pic\download (48).png"
                alt=""
              />
              <div className="flex flex-col items-start gap-0 justify-center ">
                <p className="font-semibold dark:text-slate-200 text-gray-700  text-sm">
                  Pristia Candira
                </p>
                <p className="font-normal dark:text-slate-400 text-gray-500  text-xs">
                  et8302tn@gmail.com
                </p>
              </div>
            </div>
          ...
          <td
            className={` dark:border-slate-700  border-b border-gray-100 px-4 py-2 `}
          >
            Developer
          </td>
          <td
          ...
          >
            <div className="flex w-full justify-between items-center px-6 text-center">
              <p className="font-semibold bg-green-100 flex-1 py-0.5 rounded ">
                Active
              </p>
              <img
          ...
          >
            <div className="flex w-full justify-center gap-1.5 items-center ">
              ...
              <div
                className="p-1.5 bg-red-800 rounded-md cursor-pointer"
                onClick={() => {
                  // Mock delete action
  ...
  return (
    <div className="flex flex-col gap-6 p-4 shadow  rounded-md h-full">
      <div
        className={`bg-white flex-col  dark:bg-slate-800 flex justify-evenly h-fit  `}
      >
        <Header Title={'My Attendance'} Breadcrumb={'Manage your Attendance'}>
          <div
            className={`flex border  text-slate-700 items-center  justify-center gap-1.5 px-5 py-2.5 rounded-md`}
          >
      ...
      <div className="flex-1 flex flex-col overflow-y-scroll scrollbar-hidden overflow-hidden">
        <table
          className={`  bg-white  dark:bg-slate-300 border-b border-gray-300 `}
        >
          {table_header}
          {table_content}
        </table>
      ...
      <div
        className={`bg-white flex justify-evenly h-16 gap-3  dark:bg-slate-800 `}
      >
        {pagination}
      </div>
    </div>
